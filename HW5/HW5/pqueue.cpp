...
void pqueue::push(const value_type& new_data) {
...
void pqueue::swap(size_type in1, size_type in2) {
...
//Otherwise return 0
int pqueue::compare(size_type v1, size_type v2) const {
...
pqueue::size_type pqueue::get_size() const {
	return size;
}